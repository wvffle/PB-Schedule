...
import static net.wvffle.android.pb.schedule.views.WeekViewUtil.daysBetween;
import static net.wvffle.android.pb.schedule.views.WeekViewUtil.getPassedMinutesInDay;
...
//        AndroidThreeTen.init(context); nie dziala
